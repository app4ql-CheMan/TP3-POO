...
namespace std
{
	...
	std::ostream & operator <<(std::ostream & out, std::vector<T, allocator_t> const & vector)
	{
	...
	/// @ingroup hopp_print
	template <class T, class allocator_t>
	std::ostream & operator <<(std::ostream & out, std::list<T, allocator_t> const & list)
	{
	...
	/// @ingroup hopp_print
	template <class T, class allocator_t>
	std::ostream & operator <<(std::ostream & out, std::forward_list<T, allocator_t> const & list)
	{
		hopp::print_container(out, list);
		return out;
	}
	...
	/// @ingroup hopp_print
	template <class T, class allocator_t>
	std::ostream & operator <<(std::ostream & out, std::deque<T, allocator_t> const & deque)
	{
	...
	std::ostream & operator <<(std::ostream & out, std::stack<T, container_t> const & stack)
	{
	...
	/// @ingroup hopp_print
	template <class T, class container_t>
	std::ostream & operator <<(std::ostream & out, std::queue<T, container_t> const & queue)
	{
	...
	/// @return the output stream
	/// @ingroup hopp_print
	template <class T, class compare_t, class allocator_t>
	std::ostream & operator <<(std::ostream & out, std::set<T, compare_t, allocator_t> const & set)
	{
	...
	/// @ingroup hopp_print
	template <class T, class compare_t, class allocator_t>
	std::ostream & operator <<(std::ostream & out, std::multiset<T, compare_t, allocator_t> const & set)
	{
		hopp::print_container(out, set);
		return out;
	}
	...
	/// @return the output stream
	/// @ingroup hopp_print
	template <class T, class hash_t, class key_equal_t, class allocator_t>
	std::ostream & operator <<(std::ostream & out, std::unordered_set<T, hash_t, key_equal_t, allocator_t> const & set)
	{
		hopp::print_container(out, set);
		return out;
	}
	
	/// @brief Operator << between a std::ostream and a std::unordered_multiset
	/// @param[in,out] out Output stream
	/// @param[in]     set A std::unordered_multiset
	/// @return the output stream
	/// @ingroup hopp_print
	template <class T, class hash_t, class key_equal_t, class allocator_t>
	std::ostream & operator <<(std::ostream & out, std::unordered_multiset<T, hash_t, key_equal_t, allocator_t> const & set)
	{
		hopp::print_container(out, set);
		return out;
	}
	...
	/// @return the output stream
	/// @ingroup hopp_print
	template <class key_t, class T, class compare_t, class allocator_t>
	std::ostream & operator <<(std::ostream & out, std::map<key_t, T, compare_t, allocator_t> const & map)
	{
	...
	/// @ingroup hopp_print
	template <class key_t, class T, class compare_t, class allocator_t>
	std::ostream & operator <<(std::ostream & out, std::multimap<key_t, T, compare_t, allocator_t> const & map)
	{
		hopp::print_map(out, map);
		return out;
	}
	...
	/// @return the output stream
	/// @ingroup hopp_print
	template <class key_t, class T, class hash_t, class key_equal_t, class allocator_t>
	std::ostream & operator <<(std::ostream & out, std::unordered_map<key_t, T, hash_t, key_equal_t, allocator_t> const & map)
	{
		hopp::print_map(out, map);
		return out;
	}
	
	/// @brief Operator << between a std::ostream and a std::unordered_multimap
	/// @param[in,out] out Output stream
	/// @param[in]     map A std::unordered_multimap
	/// @return the output stream
	/// @ingroup hopp_print
	template <class key_t, class T, class hash_t, class key_equal_t, class allocator_t>
	std::ostream & operator <<(std::ostream & out, std::unordered_multimap<key_t, T, hash_t, key_equal_t, allocator_t> const & map)
	{
		hopp::print_map(out, map);
		return out;
	}
