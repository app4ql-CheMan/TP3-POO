...
{
	/**
	 * @brief Specific value to create disengaged hopp::optional
	 *
	 * @code
	...
	public:
		...
		optional() : m_engaged(false), m_value()
		{ }
		
		/// @brief Constructor from hopp::nullopt_t
		/// @param[in] value Value
		optional(hopp::nullopt_t const nullopt) : optional()
		{ hopp_unused(nullopt); }
		...
		std::remove_reference_t<T> const * operator ->() const { return &value(); }
