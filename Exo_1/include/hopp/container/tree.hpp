...
namespace hopp
{
	...
	public:
		...
		/// @brief Get children
		/// @return children
		hopp::tree<T> const & children() const { return m_children; }
		
		/// @brief Get children
		/// @return children
		hopp::tree<T> & children() { return m_children; }
	...
	public:
		...
		tree(size_t const size, T const & default_value = T()) :
