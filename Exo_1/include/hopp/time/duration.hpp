...
namespace hopp
{
	...
	namespace duration
	{
		...
		/// @copydoc hopp::duration::nanoseconds(duration_t const & duration)
		template <class T = double, class duration_t>
		T ns(duration_t const & duration) { return hopp::duration::nanoseconds<T>(duration); }
		
		/// @copydoc hopp::duration::microseconds(duration_t const & duration)
		template <class T = double, class duration_t>
		T us(duration_t const & duration) { return hopp::duration::microseconds<T>(duration); }
		
		/// @copydoc hopp::duration::milliseconds(duration_t const & duration)
		template <class T = double, class duration_t>
		T ms(duration_t const & duration) { return hopp::duration::milliseconds<T>(duration); }
		
		/// @copydoc hopp::duration::seconds(duration_t const & duration)
		template <class T = double, class duration_t>
		T s(duration_t const & duration) { return hopp::duration::seconds<T>(duration); }
		
		/// @copydoc hopp::duration::minutes(duration_t const & duration)
		template <class T = double, class duration_t>
		T min(duration_t const & duration) { return hopp::duration::minutes<T>(duration); }
		
		/// @copydoc hopp::duration::hours(duration_t const & duration)
		template <class T = double, class duration_t>
		T h(duration_t const & duration) { return hopp::duration::hours<T>(duration); }
	}
}
