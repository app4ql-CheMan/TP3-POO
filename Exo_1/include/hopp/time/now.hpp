...
namespace hopp
{
	...
	namespace now
	{
		...
		/// @copydoc hopp::now::nanoseconds()
		template <class T = double>
		T ns() { return hopp::now::nanoseconds<T>(); }
		
		/// @copydoc hopp::now::microseconds()
		template <class T = double>
		T us() { return hopp::now::microseconds<T>(); }
		
		/// @copydoc hopp::now::milliseconds()
		template <class T = double>
		T ms() { return hopp::now::milliseconds<T>(); }
		
		/// @copydoc hopp::now::seconds()
		template <class T = double>
		T s() { return hopp::now::seconds<T>(); }
		
		/// @copydoc hopp::now::minutes()
		template <class T = double>
		T min() { return hopp::now::minutes<T>(); }
		
		/// @copydoc hopp::now::hours()
		template <class T = double>
		T h() { return hopp::now::hours<T>(); }
	}
}
