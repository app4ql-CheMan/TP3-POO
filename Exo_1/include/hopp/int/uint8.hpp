...
namespace hopp
{
	...
	public:
		...
		/// @param[in] i Integer between 0 and 255
		explicit uint8(unsigned int const i) : i(static_cast<unsigned char>(i)) { }
		
		/// @brief Constructor from unsigned int
		/// @param[in] i Integer between 0 and 255
		explicit uint8(long unsigned int const i) : i(static_cast<unsigned char>(i)) { }
		
		/// @brief Constructor from unsigned int
		/// @param[in] i Integer between 0 and 255
		explicit uint8(long long unsigned int const i) : i(static_cast<unsigned char>(i)) { }
		
		/// @brief Constructor from int
		/// @param[in] i Integer between 0 and 255
		explicit uint8(int const i) : i(static_cast<unsigned char>(i)) { }
		
		/// @brief Constructor from int
		/// @param[in] i Integer between 0 and 255
		explicit uint8(long int const i) : i(static_cast<unsigned char>(i)) { }
		
		/// @brief Constructor from int
		/// @param[in] i Integer between 0 and 255
		explicit uint8(long long int const i) : i(static_cast<unsigned char>(i)) { }
